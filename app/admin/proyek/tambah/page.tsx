      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-teal-950 via-teal-900 to-teal-800 rounded-3xl p-8 md:p-10 text-white shadow-2xl">
        ...
        <div className="relative">
          ...
          <h1 className="text-2xl md:text-3xl font-extrabold font-heading mb-2">
            Tambah Proyek <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-amber-500">Baru</span>
          </h1>
          <p className="text-teal-200/80 text-sm">Buat proyek wakaf baru untuk ditampilkan di marketplace</p>
        </div>
      </div>
      <ProjectForm />
    </div>
